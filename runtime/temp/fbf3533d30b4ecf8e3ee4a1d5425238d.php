<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:75:"/home/www/wwwroot/www.fa.com/addons/cms/view/default/common/index_list.html";i:1583043030;s:69:"/home/www/wwwroot/www.fa.com/addons/cms/view/default/common/item.html";i:1583043030;}*/ ?>
<?php $page=request()->get('page/d',1);$offset=($page-1)*10; ?>

<!-- S 首页列表 -->
<?php $__KoSeHB5ZT6__ = \addons\cms\model\Archives::getArchivesList(["id"=>"item","cache"=>"false","orderby"=>"weigh","limit"=>"$offset,10"]); if(is_array($__KoSeHB5ZT6__) || $__KoSeHB5ZT6__ instanceof \think\Collection || $__KoSeHB5ZT6__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__KoSeHB5ZT6__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
...
<?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__KoSeHB5ZT6__; ?>
<!-- E 首页列表 -->
