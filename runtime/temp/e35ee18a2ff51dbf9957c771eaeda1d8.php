<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:80:"/home/www/wwwroot/www.fa.com/public/../application/index/view/user/register.html";i:1583324148;s:71:"/home/www/wwwroot/www.fa.com/application/index/view/layout/default.html";i:1577702906;s:68:"/home/www/wwwroot/www.fa.com/application/index/view/common/meta.html";i:1583323585;s:70:"/home/www/wwwroot/www.fa.com/application/index/view/common/topnav.html";i:1577714341;s:71:"/home/www/wwwroot/www.fa.com/application/index/view/common/captcha.html";i:1577256740;s:70:"/home/www/wwwroot/www.fa.com/application/index/view/common/script.html";i:1577698867;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
    ...
    <div class="user-section login-section">
        ...
        <div class="login-main"> 
            <form name="form1" id="register-form" class="form-vertical" method="POST" action="">
                ...
                <?php echo token(); ?>
                <div class="form-group" align="center", style="justify-content: space-around; display: -webkit-flex; display: flex;">
                    <label><input name="accounttype" type="radio" value="1" checked/><?php echo __('Enterprise'); ?></label>
                    <label><input name="accounttype" type="radio" value="2"/><?php echo __('Bank'); ?></label>
                </div>
                <div class="form-group" id="companyname_1">
                    <label class="control-label required"><?php echo __('Company Full Name'); ?><span class="text-success"></span></label>
                    <div class="controls">
                        <input type="text" name="companyname" id="companyname"  class="form-control input-lg"
                               placeholder="<?php echo __('Please enter the full name of the company consistent with the company\'s license data'); ?>">
                        <p class="help-block"></p>
                    </div>
                </div>
                <div class="form-group hide" id="companyname_2">
                    <label class="control-label required"><?php echo __('bank Name'); ?><span class="text-success"></span></label>
                    <div class="controls">
                        <select name="companyname" class="form-control" style="height:42px;padding:0px 16px;font-size:15px;"></select>
                    </div>
                </div>
...
<?php elseif("mobile" == 'wechat'): if(get_addon_info('wechat')): ?>
