<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:71:"/home/www/wwwroot/www.fa.com/addons/cms/view/default/list_download.html";i:1583043030;s:71:"/home/www/wwwroot/www.fa.com/addons/cms/view/default/common/layout.html";i:1583161787;s:78:"/home/www/wwwroot/www.fa.com/addons/cms/view/default/common/item_download.html";i:1583043030;}*/ ?>
<!DOCTYPE html>
<!--[if lt IE 7]>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <?php $__lyizY4FcEG__ = \addons\cms\model\Channel::getChannelList(["id"=>"nav","type"=>"top","condition"=>"1=isnav"]); if(is_array($__lyizY4FcEG__) || $__lyizY4FcEG__ instanceof \think\Collection || $__lyizY4FcEG__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__lyizY4FcEG__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$nav): $mod = ($i % 2 );++$i;?>
                    <!--判断是否有子级或高亮当前栏目-->
                    <li class="<?php if($nav['has_child']): ?>dropdown<?php endif; if($nav->is_active): ?> active<?php endif; ?>">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            <?php $__Jz5YfnjNmZ__ = \addons\cms\model\Channel::getChannelList(["id"=>"sub","type"=>"son","typeid"=>$nav['id'],"condition"=>"1=isnav"]); if(is_array($__Jz5YfnjNmZ__) || $__Jz5YfnjNmZ__ instanceof \think\Collection || $__Jz5YfnjNmZ__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__Jz5YfnjNmZ__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$sub): $mod = ($i % 2 );++$i;?>
                            <li><a href="<?php echo $sub['url']; ?>"><?php echo $sub['name']; ?></a></li>
                            <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__Jz5YfnjNmZ__; ?>
                        </ul>
                    </li>
                    <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__lyizY4FcEG__; ?>
                </ul>
...
<div class="container" id="content-container">
    ...
    <h1 class="category-title">
        ...
        <div class="more pull-right">
            <ol class="breadcrumb">
                <!-- S 面包屑导航 -->
                <?php $__FmCGQdTHrv__ = \addons\cms\model\Channel::getBreadcrumb(isset($__CHANNEL__)?$__CHANNEL__:[], isset($__ARCHIVES__)?$__ARCHIVES__:[], isset($__TAGS__)?$__TAGS__:[], isset($__PAGE__)?$__PAGE__:[]); if(is_array($__FmCGQdTHrv__) || $__FmCGQdTHrv__ instanceof \think\Collection || $__FmCGQdTHrv__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__FmCGQdTHrv__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
                <li><a href="<?php echo $item['url']; ?>"><?php echo $item['name']; ?></a></li>
                <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__FmCGQdTHrv__; ?>
                <!-- E 面包屑导航 -->
            </ol>
        </div>
    </h1>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="tabs-wrapper">
                <?php $__qQ0m6oKlcz__ = \addons\cms\model\Archives::getPageFilter($__FILTERLIST__, ["id"=>"filter","exclude"=>""]); if(is_array($__qQ0m6oKlcz__) || $__qQ0m6oKlcz__ instanceof \think\Collection || $__qQ0m6oKlcz__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__qQ0m6oKlcz__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$filter): $mod = ($i % 2 );++$i;?>
                ...
                <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__qQ0m6oKlcz__; ?>
                <!-- E 分类列表 -->
            </div>
        </div>
    </div>
            ...
            <div class="panel panel-default">
                    ...
                    <h3 class="panel-title">
                        ...
                        <div class="more">
                            <ul class="list-unstyled list-inline category-order clearfix">
                                <!-- S 排序 -->
                                <?php $__dv0qFBAr1h__ = \addons\cms\model\Archives::getPageOrder($__ORDERLIST__, ["id"=>"order"]); if(is_array($__dv0qFBAr1h__) || $__dv0qFBAr1h__ instanceof \think\Collection || $__dv0qFBAr1h__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__dv0qFBAr1h__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$order): $mod = ($i % 2 );++$i;?>
                                <li><a href="<?php echo $order['url']; ?>" class="<?php echo !empty($order['active'])?'active':''; ?>"><?php echo $order['title']; ?></a></li>
                                <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__dv0qFBAr1h__; ?>
                                <!-- E 排序 -->
                            </ul>
                        </div>
                    </h3>
                ...
                <div class="panel-body py-0">
                    <div class="article-list row">
                        <!-- S 列表 -->
                        <?php $__CtVxGYRWDF__ = \addons\cms\model\Archives::getPageList($__PAGELIST__, ["id"=>"item"]); if(is_array($__CtVxGYRWDF__) || $__CtVxGYRWDF__ instanceof \think\Collection || $__CtVxGYRWDF__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__CtVxGYRWDF__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
            ...
            <div class="media-body">
                ...
                <div class="article-tag">
                    ...
                    <span itemprop="date"><?php echo date("Y年m月d日", $item['publishtime']); ?></span>
                        ...
                        <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__CtVxGYRWDF__; ?>
                        <!-- E 列表 -->
