<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:74:"/home/www/wwwroot/www.fa.com/addons/cms/view/default/channel_download.html";i:1583043030;s:71:"/home/www/wwwroot/www.fa.com/addons/cms/view/default/common/layout.html";i:1583161787;}*/ ?>
<!DOCTYPE html>
<!--[if lt IE 7]>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <?php $__HkZOYRImlq__ = \addons\cms\model\Channel::getChannelList(["id"=>"nav","type"=>"top","condition"=>"1=isnav"]); if(is_array($__HkZOYRImlq__) || $__HkZOYRImlq__ instanceof \think\Collection || $__HkZOYRImlq__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__HkZOYRImlq__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$nav): $mod = ($i % 2 );++$i;?>
                    <!--判断是否有子级或高亮当前栏目-->
                    <li class="<?php if($nav['has_child']): ?>dropdown<?php endif; if($nav->is_active): ?> active<?php endif; ?>">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            <?php $__dgZuIr2EK7__ = \addons\cms\model\Channel::getChannelList(["id"=>"sub","type"=>"son","typeid"=>$nav['id'],"condition"=>"1=isnav"]); if(is_array($__dgZuIr2EK7__) || $__dgZuIr2EK7__ instanceof \think\Collection || $__dgZuIr2EK7__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__dgZuIr2EK7__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$sub): $mod = ($i % 2 );++$i;?>
                            <li><a href="<?php echo $sub['url']; ?>"><?php echo $sub['name']; ?></a></li>
                            <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__dgZuIr2EK7__; ?>
                        </ul>
                    </li>
                    <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__HkZOYRImlq__; ?>
                </ul>
...
<div class="container" id="content-container">
    <h1 class="category-title">
        ...
        <div class="more pull-right">
            <ol class="breadcrumb">
                <!-- S 面包屑导航 -->
                <?php $__qHsGinxl9W__ = \addons\cms\model\Channel::getBreadcrumb(isset($__CHANNEL__)?$__CHANNEL__:[], isset($__ARCHIVES__)?$__ARCHIVES__:[], isset($__TAGS__)?$__TAGS__:[], isset($__PAGE__)?$__PAGE__:[]); if(is_array($__qHsGinxl9W__) || $__qHsGinxl9W__ instanceof \think\Collection || $__qHsGinxl9W__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__qHsGinxl9W__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
                <li><a href="<?php echo $item['url']; ?>"><?php echo $item['name']; ?></a></li>
                <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__qHsGinxl9W__; ?>
                <!-- E 面包屑导航 -->
            </ol>
        </div>
    </h1>
    ...
    <div class="row">
        <div class="col-xs-12 col-md-7">
            <div id="download-focus" class="carousel slide carousel-focus" data-ride="carousel">
                <ol class="carousel-indicators">
                    <?php $__nvfyu3m2c5__ = \addons\cms\model\Block::getBlockList(["id"=>"block","name"=>"downloadfocus","row"=>"2"]); if(is_array($__nvfyu3m2c5__) || $__nvfyu3m2c5__ instanceof \think\Collection || $__nvfyu3m2c5__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__nvfyu3m2c5__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$block): $mod = ($i % 2 );++$i;?>
                    <li data-target="#download-focus" data-slide-to="<?php echo $i-1; ?>" class="<?php if($i==1): ?>active<?php endif; ?>"></li>
                    <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__nvfyu3m2c5__; ?>
                </ol>
                <div class="carousel-inner" role="listbox">
                    <?php $__dOZtK1c4me__ = \addons\cms\model\Block::getBlockList(["id"=>"block","name"=>"downloadfocus","row"=>"2"]); if(is_array($__dOZtK1c4me__) || $__dOZtK1c4me__ instanceof \think\Collection || $__dOZtK1c4me__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__dOZtK1c4me__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$block): $mod = ($i % 2 );++$i;?>
                    ...
                    <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__dOZtK1c4me__; ?>
                </div>
        ...
        <div class="col-xs-12 col-md-5 focus-img">
            <div class="row">
                <?php $__p2wh3rEx8G__ = \addons\cms\model\Block::getBlockList(["id"=>"item","name"=>"downloadfocus","limit"=>"2,4"]); if(is_array($__p2wh3rEx8G__) || $__p2wh3rEx8G__ instanceof \think\Collection || $__p2wh3rEx8G__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__p2wh3rEx8G__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
                <div class="col-xs-6">
                ...
                <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__p2wh3rEx8G__; ?>
            </div>
        </div>
    </div>
    <div class="row mt-2">
            ...
            <div class="panel panel-default">
                <div class="panel-body pt-0">
                    <div class="channel-list">
                        <div class="row">
                            <!-- S 栏目列表 -->
                            <?php $__UrSC9Q5BNb__ = \addons\cms\model\Channel::getChannelList(["id"=>"channel","type"=>"son","typeid"=>$__CHANNEL__['id']]); if(is_array($__UrSC9Q5BNb__) || $__UrSC9Q5BNb__ instanceof \think\Collection || $__UrSC9Q5BNb__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__UrSC9Q5BNb__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$channel): $mod = ($i % 2 );++$i;?>
                            <div class="col-xs-12">
                                <h3><?php echo $channel['textlink']; ?> <em><a href="<?php echo $channel['url']; ?>"><?php echo __('More'); ?></a></em></h3>
                                <ul class="list-unstyled download-list">
                                    <?php $__pfJwVIKYrX__ = \addons\cms\model\Archives::getArchivesList(["id"=>"item","channel"=>$channel['id'],"limit"=>"20"]); if(is_array($__pfJwVIKYrX__) || $__pfJwVIKYrX__ instanceof \think\Collection || $__pfJwVIKYrX__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__pfJwVIKYrX__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
                                    <li>
                                    ...
                                    <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__pfJwVIKYrX__; ?>
                                </ul>
                            </div>
                            <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__UrSC9Q5BNb__; ?>
                            <!-- E 栏目列表 -->
                        </div>
                    </div>
                </div>
