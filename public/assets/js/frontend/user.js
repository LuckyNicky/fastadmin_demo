    ...
    var Controller = {
        ...
        register: function () {
            ...
            for(var i=0; i<banklist.length;i++){
                var option = $("<option></option>").text(banklist[i].text).val(banklist[i].value);
                $("#companyname_2 select").append(option);
            }

            // $('#companyname_1 input').attr("data-rule", 'required;companyname');

            $(document).on("change", "input[name=accounttype]", function () {
                var type = $(this).val();
                if (type==1) {
                    $('#companyname_1').removeClass("hide");
                    $('#companyname_2').addClass("hide");
                }else{
                    $('#companyname_2').removeClass("hide");
                    $('#companyname_1').addClass("hide");
                }
            });
